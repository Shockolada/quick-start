...
/* harmony import */ var _modules_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header */ "./source/js/modules/header.js");
/* harmony import */ var _modules_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/menu */ "./source/js/modules/menu.js");
/* harmony import */ var _modules_push_footer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/push-footer */ "./source/js/modules/push-footer.js");
/* harmony import */ var _services_sliding__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/sliding */ "./source/js/services/sliding.js");
/* harmony import */ var _services_sliding__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_services_sliding__WEBPACK_IMPORTED_MODULE_6__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_push_footer__WEBPACK_IMPORTED_MODULE_5__["default"])();
...
var menu = function menu() {
  ...
  menuTrigger.addEventListener('click', function (evt) {
    ...
    if (menu.classList.contains('active')) {
      menu.classList.remove('active'); // document.removeEventListener('click', onOutClick);
    } else {
      menu.classList.add('active'); // document.addEventListener('click', onOutClick);
    }
...
/* harmony import */ var _services_calc_scroll_width__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/calc-scroll-width */ "./source/js/services/calc-scroll-width.js");
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector) {
    var closeSelector = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.modal__close';
    var trigger = document.querySelectorAll(triggerSelector),
        modal = document.querySelector(modalSelector),
        close = document.querySelectorAll(closeSelector),
        overlay = document.querySelector('.modal-overlay'),
        scrollWidth = Object(_services_calc_scroll_width__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
/***/ "./source/js/modules/push-footer.js":
/*!******************************************!*\
  !*** ./source/js/modules/push-footer.js ***!
  \******************************************/
/*! exports provided: default */
...
var pushFooterDown = function pushFooterDown() {
  function footer(footerSelector) {
    try {
      var windowHeight = document.documentElement.clientHeight,
          _footer = document.querySelector(footerSelector),
          footerHeight = _footer.offsetHeight;

      var footerTop = _footer.offsetTop + footerHeight;

      if (window.getComputedStyle(_footer).marginTop.replace(/\D/g, "") > 0) {
        footerTop = _footer.offsetTop + footerHeight - Number(window.getComputedStyle(_footer).marginTop.replace(/\D/g, ""));
      }

      if (footerTop < windowHeight) {
        _footer.style.marginTop = "".concat(windowHeight - footerTop, "px");
      }
    } catch (err) {}
  }
...
/* harmony default export */ __webpack_exports__["default"] = (pushFooterDown);

/***/ }),

/***/ "./source/js/services/calc-scroll-width.js":
/*!*************************************************!*\
  !*** ./source/js/services/calc-scroll-width.js ***!
  \*************************************************/
/*! exports provided: default */
